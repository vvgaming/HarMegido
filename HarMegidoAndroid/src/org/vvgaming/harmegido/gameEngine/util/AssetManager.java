...
/**
 * Gerenciador de recursos que d� acesso aos nativos do Android e mantem alguns em seu dom�nio para evitar duplicidade em mem�ria
 * 
...
public class AssetManager
{
	...
	public Bitmap getBitmap(final int bmpId)
	{
		...
		{
			bitmaps.put(bmpId, retorno = BitmapFactory.decodeResource(act.getResources(), bmpId));
		}
		return retorno;
	}

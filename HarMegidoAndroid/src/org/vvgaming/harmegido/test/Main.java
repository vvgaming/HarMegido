...
import org.vvgaming.harmegido.test.interfaceTest.InterfaceTestActivity;
...
public class Main extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		((Button) findViewById(R.id.btnStateTest)).setOnClickListener(new View.OnClickListener()
		{
			@Override
			public void onClick(View v)
			{
				Intent i = new Intent(getApplicationContext(), TesteState.class);
				startActivity(i);
			}
		});

		((Button) findViewById(R.id.btnTesteInterface)).setOnClickListener(new View.OnClickListener()
		{
			@Override
			public void onClick(View v)
			{
				Intent i = new Intent(getApplicationContext(), InterfaceTestActivity.class);
				startActivity(i);
			}
		});

...
public class ServerDriverFacade
{
	 ...
	 * 
	 * @param nomePartida O nome a ser vinculado com a partida. Não pode coincidir com o nome de nenhuma outra partida.
	 * @param duracao A duração da partida
	 * @return Uma instância de {@link Either} que irá conter em Right a partida criada, ou Left a exceção que aconteceu.
	 */
	 ...
	 * @return Uma instância de {@link Either} que conterá <tt>true</tt> se o jogador foi adicionado, ou a exceção em caso contrário
	 */
	 ...
	 * @return Uma instância de {@link Either} que conterá <tt>true</tt> se o jogador foi removido, ou a exceção em caso contrário
	 */
	 ...
	 * @return Uma instância de {@link Either} que conterá <tt>true</tt> se o jogador teve o time trocado, ou a exceção em caso contrário
	 */
	 ...
	 * @return Uma instância de {@link Either} que conterá <tt>true</tt> se o jogador encantou o objeto, ou a exceção em caso contrário
	 */
	 ...
	 * @return Uma instância de {@link Either} que conterá <tt>true</tt> se o jogador desencantou o objeto, ou a exceção em caso contrário
	 */
	 ...
	 * @return Uma instância de {@link Either} que conterá <tt>true</tt> se houve sucesso, ou a exceção que ocorreu em caso contrário
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * 
	 * @return Uma instância de {@link Either} que conterá uma lista com o nome das partidas ativas, ou a exceção em caso de erro
	 */
	@SuppressWarnings("unchecked")
	...
	private Either<Exception, Response> callService(final String serviceName, final Tuple2<String, Object>... params)
	{
		...
		if (params != null)
		{
			for (final Tuple2<String, Object> curParam : params)
			{
